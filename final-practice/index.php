    ...
    <main>
        ...
        <sction class="news">
            <div class="inner news__inner">
                ...
                <div class="news__box--2">
                    <div class="news__box">
                        <time class="news__date">2022/12/21</time>
                        <p class="news__category">営業日時</p>
                    </div>
                    <p class="news__title">年末年始の営業時間について</p>
                </div>
                <a class="news__link" href="information.html">→ お知らせ一覧へ</a>
            </div>
        </sction>
        <!---コンセプトここから--->
                ...
                <div class="concept__box">
                    <div class="concept--left">
                        ...
                        <div class="concept__link-box">
                            <a class="concept__link" href="about.html">→ 当院について</a>
                        </div>
                    </div>
        ...
        <section class="course">
            <div class="container inner">
                ...
                <a class="course__link" href="#">→ コース・料金詳細へ</a>
            </div>
        ...
        <section class="voice">
            ...
            <div class="inner">
                ...
                <a class="voice__link" href="voice.html">→ お客様の声一覧へ</a>
            </div>
        </section>
    </main>
